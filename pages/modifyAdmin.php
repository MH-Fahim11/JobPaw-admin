      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-md-12">
             <div class="card">
               <h4 class="card-header text-primary">Modifier : <span>stage@jobpaw.com</span></h4>
               <small class="ms-5"><a href="">Ajouter un administrateur</a></small>
                <div class="card-body">
                    <form>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Nouveau mot de passe</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <label for="smallSelect" class=" col-sm-2 col-form-label">Niveau d'accès</label>
                            <div class="col-sm-10">
                                <select id="smallSelect" class="form-select ">
                                    <option>Tout</option>
                                    <option value="1">One</option>
