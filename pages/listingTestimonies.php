...
<html
    ...
    <head>
        ...
        <title>Dashboard - Listing Testimonies</title>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-6">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <div>
                                    <h5 class="mb-0 text-primary">Les témoignages</h5>
                                    <small>57 témoignages</small>
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="inlineRadio1"
                                        value="option1" />
                                    <label class="form-check-label" for="inlineRadio1">Temoignage publié</label>
                                    </div>
                                    ...
                                    <input
                                        ...
                                        id="inlineRadio2"
                                        value="option2" />
                                    <label class="form-check-label" for="inlineRadio2">Témoignage non publié</label>
                                    </div>
