...
<html
    ...
    <head>
        ...
        <title>Dashboard - Listing Organizations Internationales</title>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-6">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0 text-primary">Les organisations internationales</h5>
                                <div>
                                    <small class="btn btn-primary">Ajouter une organisat</small> <br/>
                                </div>
                            </div>
