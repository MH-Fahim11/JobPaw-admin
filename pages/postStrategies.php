...
<html
  ...
  <head>
    ...
    <title>Dashboard - Post Strategies </title>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-6">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row mb-4">
                                        <label class=" col-sm-2 col-form-label" for="dropdown">Ajouter une stratégie de pays</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="basic-default-name" placeholder="Source" />
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Fichier</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-4">
                                        <label for="exampleFormControlTextarea1" class=" col-sm-2 col-form-label">Résumé</label>
                                        <div class="col-sm-10">
                                            <textarea
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="basic-default-name" placeholder="Lien vers le site" />
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <small>Uniquement des nombres (Le classement est fait suivant cette position du plus grand
                                            au plus petit)</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary">Ajouter une stratégie</button>
                                        </div>
                                    </div>
