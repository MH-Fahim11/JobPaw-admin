...
<html
    ...
    <head>
        ...
        <title>Dashboard - Listing Specialities</title>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-6">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0 text-primary">Liste de spécialités (419)</h5>
                                <div>
                                    <small class="btn btn-primary">outer une spécialité</small> <br/>
                                </div>
                            </div>
                            <small class=" ms-4">Cliquer sur une spécialité pour le modifier</small>
