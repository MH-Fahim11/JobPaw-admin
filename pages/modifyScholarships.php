...
<html
  ...
  <head>
    ...
    <title>Dashboard - Modify Scholarships</title>
                        ...
                        <div class="card mb-6">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <small class="text-muted ">Si vous voulez changer le type de cette bourse, vous devriez lA supprimer et ajouter l'autre</small>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Bourse <span class=" text-danger">*</span> </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="basic-default-name" placeholder="Bourse" />
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Lien <span class=" text-danger">*</span> </label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-sm-2 col-form-label" for="basic-default-company">Date de publication<span class=" text-danger">*</span> </label>
                                        <div class="form-floating form-floating-outline col-sm-10">
                                            ...
                                            <small>30 décembre 2016 serait <b>2016-12-30</b></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary">Modifier une bourse</button>
                                        </div>
                                    </div>
