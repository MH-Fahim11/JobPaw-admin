...
<html
    ...
    <head>
        ...
        <title>Dashboard - Listing Universities</title>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-6">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <div>
                                    <h5 class="mb-0 text-primary">Liste des etablissements (401)</h5>
                                    <small>Ajouter un etablissement</small> <br/>
                                    <small>Reinitaliser toutes les positions à zéro</small>
                                </div>
