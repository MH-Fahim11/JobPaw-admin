...
<html
  ...
  <head>
    ...
    <title>Dashboard - Post Training </title>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-6">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0 text-primary">Ajouter un séminaire</h5>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row mb-4">
                                        <label class=" col-sm-2 col-form-label" for="dropdown">Choisir la compagnie</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="basic-default-name" placeholder="Heure" />
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class=" col-sm-2 col-form-label" for="dropdown">Ville</label>
                                        <div class="col-sm-10">
                                        <select id="dropdown" class="form-select ">
                                                <option value="">- - Choisir - -</option>
                                                <option value="Continent">1</option>
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Cout</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="basic-default-name" placeholder="Cout" />
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="exampleFormControlTextarea1" class=" col-sm-2 col-form-label">Public Cible</label>
                                        <div class="col-sm-10">
                                            <textarea
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Position dans la liste</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="basic-default-name" placeholder="Position dans la liste" />
